...
spec.homepage     = "https://github.com/shuftipro/ios-verification-using-rest-api-binary-pod"
...
spec.source       = { :git => "https://github.com/shuftipro/ios-verification-using-rest-api-binary-pod.git", :tag => "#{spec.version}" }
